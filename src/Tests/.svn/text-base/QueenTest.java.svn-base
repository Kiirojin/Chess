...
public class QueenTest {
	...
	@Test
	public void AtestPlayerCantMoveNonExistingPiece() {
		assertFalse(playerBlack.move(0, 3, 2, 2));
	}
	
	@Test
	public void BtestDiagonalMove() {
		assertTrue(playerBlack.move(4, 0, 2, 2)); 
	}
	
	@Test
	public void CtestVerticalAndKillMove() {
		assertTrue(playerBlack.move(2, 2, 2, 6)); 
	}
	
	@Test
	public void DtestCantPhaseThroughThings() {
		assertFalse(playerBlack.move(2, 6, 4, 6)); 
	}
	
	@Test
	public void EtestDiagonalAndKillMove() {
